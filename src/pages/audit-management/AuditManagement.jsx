...
const AuditManagement = () => {
  ...
  return (
    <div>
            ...
            <div className="mt-5">
                <div className="flex items-center justify-between px-3 pt-6 mb-4">
                  ...
                  <div className="flex items-center gap-3">
                    <button onClick={() => setScheduleAnAudit(true)} className="text-[14px] bg-secondary-color text-primary-color">Schedule an audit</button>
      ...
      {
        scheduleAnAudit && <ScheduleAnAudit applications={applications} setScheduleAnAudit={setScheduleAnAudit}/>
      }
    </div>
  );
}
