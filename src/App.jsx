...
import CertificationApplicationView from './pages/certification-application-view/CertificationApplicationView'
  ...
  return (
    <HashRouter>
      <Routes>
        ...
        <Route path='/supplier-verification/application/:id' element={<SupplierVerificationApplicationInfo />}/>
        ...
        <Route path='/certifications/application/:id' element={<CertificationApplicationView />}/>
